...
<body>
<jsp:include page="WEB-INF/common/navbar-header.jsp">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <%--                                    <tbody>--%>
                        <%--                                    <tr>--%>
                        <%--                                        <th scope="row"><a href="#"><img src="resource/assets/img/product-1.jpg" alt=""></a></th>--%>
                        ...
                        <%--                                    </tr>--%>
                        <%--                                    <tr>--%>
                        <%--                                        <th scope="row"><a href="#"><img src="resource/assets/img/product-2.jpg" alt=""></a></th>--%>
                        ...
                        <%--                                    </tr>--%>
                        <%--                                    <tr>--%>
                        <%--                                        <th scope="row"><a href="#"><img src="resource/assets/img/product-3.jpg" alt=""></a></th>--%>
                        ...
                        <%--                                    </tr>--%>
                        <%--                                    <tr>--%>
                        <%--                                        <th scope="row"><a href="#"><img src="resource/assets/img/product-4.jpg" alt=""></a></th>--%>
                        ...
                        <%--                                    </tr>--%>
                        <%--                                    <tr>--%>
                        <%--                                        <th scope="row"><a href="#"><img src="resource/assets/img/product-5.jpg" alt=""></a></th>--%>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <%--                                <img src="resource/assets/img/news-1.jpg" alt="">--%>
                    <%--                                <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>--%>
                    <%--                                <p>Sit recusandae non aspernatur laboriosam. Quia enim eligendi sed ut harum...</p>--%>
                    <%--                            </div>--%>

                    <%--                            <div class="post-item clearfix">--%>
                    <%--                                <img src="resource/assets/img/news-2.jpg" alt="">--%>
                    <%--                                <h4><a href="#">Quidem autem et impedit</a></h4>--%>
                    <%--                                <p>Illo nemo neque maiores vitae officiis cum eum turos elan dries werona nande...</p>--%>
                    <%--                            </div>--%>

                    <%--                            <div class="post-item clearfix">--%>
                    <%--                                <img src="resource/assets/img/news-3.jpg" alt="">--%>
                    <%--                                <h4><a href="#">Id quia et et ut maxime similique occaecati ut</a></h4>--%>
                    <%--                                <p>Fugiat voluptas vero eaque accusantium eos. Consequuntur sed ipsam et totam...</p>--%>
                    <%--                            </div>--%>

                    <%--                            <div class="post-item clearfix">--%>
                    <%--                                <img src="resource/assets/img/news-4.jpg" alt="">--%>
                    <%--                                <h4><a href="#">Laborum corporis quo dara net para</a></h4>--%>
                    <%--                                <p>Qui enim quia optio. Eligendi aut asperiores enim repellendusvel rerum cuder...</p>--%>
                    <%--                            </div>--%>

                    <%--                            <div class="post-item clearfix">--%>
                    <%--                                <img src="resource/assets/img/news-5.jpg" alt="">--%>
