...
<%--    <!--Vendor JS file-->--%>
<%--    &lt;%&ndash;    <script src="https://cdnjs.cloudflare.com/ajax/libs/apexcharts/3.36.3/apexcharts.min.js"&ndash;%&gt;--%>
<%--    &lt;%&ndash;            integrity="sha512-sa449wQ9TM6SvZV7TK7Zx/SjVR6bc7lR8tRz1Ar4/R6X2jOLaFln/9C+6Ak2OkAKZ/xBAKJ94dQMeYa0JT1RLg=="&ndash;%&gt;--%>
<%--    &lt;%&ndash;            crossorigin="anonymous" referrerpolicy="no-referrer"></script>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.3/js/bootstrap.min.js"&ndash;%&gt;--%>
<%--    &lt;%&ndash;            integrity="sha512-1/RvZTcCDEUjY/CypiMz+iqqtaoQfAITmNSJY17Myp4Ms5mdxPS5UV7iOfdZoxcGhzFbOm6sntTKJppjvuhg4g=="&ndash;%&gt;--%>
<%--    &lt;%&ndash;            crossorigin="anonymous" referrerpolicy="no-referrer"></script>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.2.3/js/bootstrap.bundle.min.js"&ndash;%&gt;--%>
<%--    &lt;%&ndash;            integrity="sha512-i9cEfJwUwViEPFKdC1enz4ZRGBj8YQo6QByFTF92YXHi7waCqyexvRD75S5NVTsSiTv7rKWqG9Y5eFxmRsOn0A=="&ndash;%&gt;--%>
<%--    &lt;%&ndash;            crossorigin="anonymous" referrerpolicy="no-referrer"></script>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/4.1.1/chart.min.js"&ndash;%&gt;--%>
<%--    &lt;%&ndash;            integrity="sha512-MC1YbhseV2uYKljGJb7icPOjzF2k6mihfApPyPhEAo3NsLUW0bpgtL4xYWK1B+1OuSrUkfOTfhxrRKCz/Jp3rQ=="&ndash;%&gt;--%>
<%--    &lt;%&ndash;            crossorigin="anonymous" referrerpolicy="no-referrer"></script>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <script src="https://cdnjs.cloudflare.com/ajax/libs/echarts/5.4.1/echarts.min.js"&ndash;%&gt;--%>
<%--    &lt;%&ndash;            integrity="sha512-OTbGFYPLe3jhy4bUwbB8nls0TFgz10kn0TLkmyA+l3FyivDs31zsXCjOis7YGDtE2Jsy0+fzW+3/OVoPVujPmQ=="&ndash;%&gt;--%>
<%--    &lt;%&ndash;            crossorigin="anonymous" referrerpolicy="no-referrer"></script>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <script src="https://cdnjs.cloudflare.com/ajax/libs/quill/1.3.7/quill.min.js"&ndash;%&gt;--%>
<%--    &lt;%&ndash;            integrity="sha512-P2W2rr8ikUPfa31PLBo5bcBQrsa+TNj8jiKadtaIrHQGMo6hQM6RdPjQYxlNguwHz8AwSQ28VkBK6kHBLgd/8g=="&ndash;%&gt;--%>
<%--    &lt;%&ndash;            crossorigin="anonymous" referrerpolicy="no-referrer"></script>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" type="text/javascript"></script>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <script src="https://cdnjs.cloudflare.com/ajax/libs/tinymce/6.3.1/tinymce.min.js"&ndash;%&gt;--%>
<%--    &lt;%&ndash;            integrity="sha512-eV68QXP3t5Jbsf18jfqT8xclEJSGvSK5uClUuqayUbF5IRK8e2/VSXIFHzEoBnNcvLBkHngnnd3CY7AFpUhF7w=="&ndash;%&gt;--%>
<%--    &lt;%&ndash;            crossorigin="anonymous" referrerpolicy="no-referrer"></script>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <script src="https://cdnjs.cloudflare.com/ajax/libs/valid.js/1.2.5/validate.js"&ndash;%&gt;--%>
<%--    &lt;%&ndash;            integrity="sha512-20uWmXlcs85IacabeDkksf23YH71H3Sgsf3S63l+8gt8bRB3OM0JxnheaqbIJfP04ZdJa4l5F5HtLm8zuT8N9Q=="&ndash;%&gt;--%>
<%--    &lt;%&ndash;            crossorigin="anonymous" referrerpolicy="no-referrer"></script>&ndash;%&gt;--%>
<%--    &lt;%&ndash;    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js"&ndash;%&gt;--%>
<%--    &lt;%&ndash;            integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ=="&ndash;%&gt;--%>
<%--    &lt;%&ndash;            crossorigin="anonymous" referrerpolicy="no-referrer"></script>&ndash;%&gt;--%>
